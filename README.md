...
1. **Download the script:** Download `hypr_pomo.py` and place it somewhere in your PATH (e.g., `~/.local/bin/`). 

2. **Install Dependencies:** Run `pip3 install rich`. 

3. **Create an Alias:** Add the following to your shell config (`~/.bashrc`, `~/.zshrc`, or `~/.config/fish/config.fish`): 
